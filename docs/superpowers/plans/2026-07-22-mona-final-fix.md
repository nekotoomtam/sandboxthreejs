...
- [x] **Step 1: Add failing order regressions**
...
- [x] **Step 1: Add failing timing-order test**
...
- [x] **Step 3: Verify build chunks and commit**
...
- [x] **Step 1: Verify Chrome behavior and console**

Check root ready/entry, one canvas, focus, `/lessons`, and local console errors.

- [x] **Step 2: Capture exact evidence**
...
- [x] **Step 3: Build combined boards and compare**
...
- [x] **Step 5: Commit reports and evidence**
